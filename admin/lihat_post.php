   ...
   ?>
    ...
    <div class="container">
        ...
        <div class="row mb-3">
            ...
            <div class="col">
                <div class="fw-bold"><?= htmlentities($topik['nama']);?></div>
            ...
            <div class="col mb-4 ">
                <div class="bg-light py-2 px-3 rounded">
                    <div class="row gx-2">
                        ...
                        <?php 
                                    // Cek jika pengguna adalah admin atau pemilik komentar
                                    if($_SESSION['user']['email'] == "admin@gmail.com" || $_SESSION['user']['id_user'] == $komentar['id_pengguna']) {
                                        ?>
                        <div class="col-auto">
